/**
 * @file base_auto_fix.h
 * @brief Base Station Auto-Fix 모드 관리
 *
 * GPS Base 타입이 고정좌표 없이 시작할 때:
 * 1. NTRIP 클라이언트로 동작하여 RTK Fix 획득
 * 2. RTK Fix 진입 후 1분간 좌표 평균 계산
 * 3. Base Station Fixed 모드로 전환 (평균 좌표 사용)
 * 4. NTRIP 및 LTE 통신 종료
 */
